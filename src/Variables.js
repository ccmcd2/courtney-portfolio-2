// colors
export const teal = '#45aab4';
export const blue = '#038db2';
export const navy = '#1b5881';
export const pink = '#f5789d';
export const orange = '#f28f64';
export const yellow = '#fbb45c';
...
// effects
export const standardDropShadow = 'drop-shadow(0 5px 0 #1b5881)';