    ...
    return (
        <main>
            ...
            <section>
                ...
                <Project image={DavidsBarbequeHome} alt="home page of David's Barbeque website" title={description.DavidsBarbequeTitle} type={description.DavidsBarbequeType} color={palette.color2} className="left">
                ...
                <Project image={Portfolio1Home} alt="home page of my first portfolio" title={description.Portfolio1Title} type={description.Portfolio1Type} color={palette.color4} className="right">
                ...
                <Project image={GrandPrairiePublicHome} alt="home page of City of Grand Prairie's website" title={description.GPPublicTitle} type={description.GPPublicType} color={palette.color5} className="right">
                ...
                <Project image={TCPHHome} alt="home page of Tarrant County Public Health's vaccine website" title={description.TCPHTitle} type={description.TCPHType} color={palette.color1} className="right">
                ...
                <Project image={Portfolio2Home} alt="home page of this website" title={description.Portfolio2Title} type={description.Portfolio2Type} color={palette.color2} className="left">
                ...
                <Project image={RealeatherHome} alt="home page of Realeather's website" title={description.RealeatherTitle} type={description.RealeatherType} color={palette.color3} className="left">
