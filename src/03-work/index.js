    ...
    return (
        <main>
            ...
            <section>
                ...
                <Project image={CAndWAntiquesHone} alt="home page of C &amp; W Antiques website" title={description.CAndWAntiquesTitle} type={description.CAndWAntiquesType}color={palette.color2} className="right">
                ...
                <Project image={CourtneyAndCaleHome} alt="home page of Courtney &amp; Cale website" title={description.CourtneyAndCaleTitle} type={description.CourtneyAndCaleType}color={palette.color3} className="left">
                ...
                <Project image={GrandPrairiePublicHome} alt="home page of City of Grand Prairie's website" title={description.GPPublicTitle} type={description.GPPublicType} color={palette.color4} className="right">
                ...
                <Project image={GrandPrairieIntranetHome} alt="home page of City of Grand Prairie's intranet" title={description.GPIntranetTitle} type={description.GPIntranetType}color={palette.color5} className="left">
                ...
                <Project image={Portfolio1Home} alt="home page of my first portfolio" title={description.Portfolio1Title} type={description.Portfolio1Type} color={palette.color1} className="right">
                ...
                <Project image={RealeatherHome} alt="home page of Realeather's website" title={description.RealeatherTitle} type={description.RealeatherType} color={palette.color2} className="left">
                ...
                <Project image={TCPHHome} alt="home page of Tarrant County Public Health's vaccine website" title={description.TCPHTitle} type={description.TCPHType} color={palette.color3} className="right">
                ...
                <Project image={Test} alt="home page of this website" title={description.Portfolio2Title} type={description.Portfolio2Type} color={palette.color4} className="left">
